...
class DealBot:
    ...
    ''' ESSA FUNÇÃO IRÁ BUSCAR TODOS NA SESSÃO DE JOGOS POPULARES NO SITE GG.DEALS UTILIZANDO SUA URL
        ...
        game_list - DICIONARIO QUE IRÁ ARMAZERAR AS INFORMAÇÕES DE TODOS OS JOGOS RECUPERADOS NA CONSULTA, AS INFORMAÇÕES
                    SÃO ARMAZENADAS DA SEGUINTE FORMA: {NOME DO JOGO: {PREÇO: DESCONTO}}.
    ...
    ''' ESSA FUNÇÃO IRÁ BUSCAR TODOS OS JOGOS GRATUITOS NA SESSÃO DE JOGOS GRATUITOS NO SITE GG.DEALS UTILIZANDO SUA URL
        ...
        game_list_div - A DIV ONDE FAREI A PESQUISA DOS JOGOS BASEADOS NA CLASSE DO SEU ELEMENTO HTML.
        game_list_elements - TODOS OS ELEMENTOS PRESENTES NA DIV GAME_LIST, TAMBÉM REALIZO A BUSCA BASEADO NA CLASSE HTML
        game_indice - INDICE USADO COMO VERIFICAÇÃO DA QUANTIDADE DE JOGOS QUE FORAM RECUPERADOS NA CONSULTA
        name - NOME DO JOGO
        price - PREÇO DO JOGO
        discount - DESCONTO APLICADO AO PREÇO DO JOGO
